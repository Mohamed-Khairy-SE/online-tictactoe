...
# Project:  main
# Template: app
# Command: /usr/bin/qmake -o Makefile main
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/abdelrahman/ME/projects/Low-Level/online-tic-tac-toe/.tmp/main1.0.0
LINK          = g++
...
Makefile: main /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
